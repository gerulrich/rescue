...
public abstract class AbstractPage implements Page {
    ...
    public Control getControl(PageContainer container, Composite parent) {
        if (composite == null) {
            ...
            actionImage = new Image(composite.getDisplay(), AbstractPage.class.getResourceAsStream("action.gif"));
...
//        container.adapt(titleText);
    ...
    protected Composite createToolBar(PageContainer container, Composite parent, int countButtons) {
    	Composite wrap = new Composite(parent, SWT.NONE);
        wrap.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
        container.adapt(wrap);
        
        GridLayout layout = new GridLayout(countButtons, false);
        layout.marginLeft = 8;
        layout.marginHeight = 0;
        wrap.setLayout(layout);
    ...
    protected void addButton(Composite parent, Image image, SelectionAdapter selectionAdapter) {
