...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                <fo:table-body>
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <fo:block><fo:external-graphic src="src/main/resources/images/fiuba_logo.png"/></fo:block>
   ...
   ################################################### -->
    ...
    <xsl:param name="admon.graphics.path">src/main/resources/images/admons/</xsl:param>
